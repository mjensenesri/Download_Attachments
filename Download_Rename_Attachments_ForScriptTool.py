...
try:
    if relclass:
        ...
        arcpy.AddError("Feature class does not have an attachment relationship class")
        sys.exit()
    ...
    # Rename attachment files based on one or more fieldnames into a subfolder - Verified
        ...
        # Rename attachment files based on one or more fieldnames exported into output folder only -
